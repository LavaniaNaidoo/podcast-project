class Store {
    /**
     * 
     * @param {import('./imports/type').sorting} newSorting 
     */
    ...
    /**
     * @param {Partial<import('./imports/type').state>} newState 
     */
    update(newState) {
    ...
    /**
     * @param {import('./imports/type').subscription} subscription 
     */
    ...
    constructor() {
        /**
         * @type {import('./imports/type').subscription[]}
         */
        this.subscriptions = []

        /**
         * @type {import('./imports/type').state}
         */
        this.state = {
            phase: 'loading',
            previews: [],
...
/**
 * 
 * @param {import('./imports/type').subscription} fn 
 * @returns 
 */
